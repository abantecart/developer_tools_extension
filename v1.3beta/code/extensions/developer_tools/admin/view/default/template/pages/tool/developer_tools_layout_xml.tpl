...
<div id="content" class="panel panel-default">
	...
	<div class="panel-body panel-body-nopadding tab-content col-xs-12 ">
		...
		<?php if($form[ 'destination_directory' ]){ ?>
			<div class="form-group">
				<label class="control-label col-sm-3 col-xs-12" ><?php echo $developer_tools_text_destination_directory; ?></label>
				<div class="input-group afield col-sm-7 col-xs-12">	<?php echo $form[ 'destination_directory' ]; ?></div>
			</div>
		<?php } ?>
	</div>
...
<script type="text/javascript">
	$('#btn-save-xml').click(function(){
		$.ajax({
			...
			type:'POST',
			dataType:'json',
			data: $('#extLayoutFrm').serializeArray(),
